class GolfersController < ApplicationController
  ...
  private
    ...
    def golfer_params
      params.require(:golfer).permit(:this_week, :name, :country, :average_points, :total_points, :events_played, :points_lost_this_year, :points_gained_this_year, :events_played)
    end
end
